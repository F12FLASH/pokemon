...
function init() {
    ...
    lottie_4_container.onclick = function() {
        openCloseMusic()
    };
    ...
    lottie_huong_dan.onclick = function() {
        huongDan()
    };
    huong_dan.onclick = function() {
        huongDan()
    };

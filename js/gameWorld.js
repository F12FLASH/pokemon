...
function init() {
    ...
    buttonOffOnMusic.onclick = function() {
        algorithm.pauseStartMusic(buttonOffOnMusicLottie)
    };
    // Thiết lập button dừng và chạy
    buttonPausePlay = document.getElementById("pause");
    buttonPausePlay.onclick = function() {
        algorithm.pauseStartGame(buttonPausePlayLottie)
    };
    ...
    document.getElementById("screenPlayGame").addEventListener("mouseup", function() {
        handleClickOnCanvas(event)
    });
    document.getElementById("screenPlayGame").addEventListener("mousemove", function() {
